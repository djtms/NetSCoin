...
static const unsigned int MAX_TX_COMMENT_LEN = 140; // netscoin: 128 bytes + little extra

static const int64 MIN_TX_FEE = 1000000;
static const int64 MIN_RELAY_TX_FEE = MIN_TX_FEE;
static const int64 MAX_MONEY = 15000000000 * COIN; // netscoin: maximum of 15 billion coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; // netscoin: 1440 blocks found a day. Priority cut-off is 1 netscoin day / 250 bytes.
    }
